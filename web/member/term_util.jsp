...
<div class="agree_fr text-start">
    제 1 장 총칙

    본 약관은 (주)그로우앤조이(이하 “회사”라 합니다)이 운영하는 웹사이트 ‘그로우앤조이’(www.Grownjoy.com) (이하 “웹 사이트”라 합니다)에서 제공하는 온라인 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.

    제 2 조 (용어의 정의)
    1. "이용자"라 함은 당 사이트에 접속하여 이 약관에 따라 당 사이트가 제공하는 서비스를 받는 회원 및 비회원을
    말합니다.
